...
JS;
		...
		$css = implode(
			...
			array(
				...
				'/* Elementor single-product templates: hide price/options/add-to-cart widgets for guests */',
				'body:not(.logged-in).single-product .elementor-widget-woocommerce-product-price,',
				'body:not(.logged-in).single-product .elementor-widget-woocommerce-product-add-to-cart,',
				...
				'\tdisplay: none !important;',
				'}',
				'body:not(.logged-in).single-product .elementor-widget-container form.cart {',
				'\tdisplay: none !important;',
				'}',
